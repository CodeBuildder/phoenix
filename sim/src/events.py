"""
Provisioning Simulator — event bus publisher
...
`phoenix/schemas/event.schema.json`) and publishes events as structured logs
instead — the same "queryable in Loki" pattern argus's audit logger uses
...
def publish_event(
    ...
    *,
    ...
    matching how argus's audit entries are queried in Grafana.
    """
